    ...
    public class ExtendedMap : Xamarin.Forms.GoogleMaps.Map
    {
        ...
        async void Update(Xamarin.Forms.GoogleMaps.Position position)
        {
            ...
            if (cPin != null)
            {
                ...
                cPin.Icon = (Device.RuntimePlatform == Device.Android) ? BitmapDescriptorFactory.FromBundle("ic_run.png") : BitmapDescriptorFactory.FromView(new Image() { Source = "ic_run.png", WidthRequest = 25, HeightRequest = 25 });
        ...
        void Calculate(List<Xamarin.Forms.GoogleMaps.Position> list)
        {
            ...
            var pin = new Xamarin.Forms.GoogleMaps.Pin
            {
                ...
                Address = "First",
                Tag = string.Empty,
                Icon = (Device.RuntimePlatform == Device.Android) ? BitmapDescriptorFactory.FromBundle("ic_run.png") : BitmapDescriptorFactory.FromView(new Image() { Source = "ic_run.png", WidthRequest = 25, HeightRequest = 25 })
